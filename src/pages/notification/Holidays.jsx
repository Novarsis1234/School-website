    ...
    <div>
     <section className="relative w-full min-h-[70vh] overflow-hidden">
       ...
       >
         ...
         <Reveal>
           <div className="text-white text-center lg:text-left">
             ...
             Holiday & <br />
               <span className="text-[#EF4444]">vacation</span>
             </h1>
      ...
      <p className="mt-10 text-gray-700 text-base sm:text-lg md:text-xl leading-relaxed font-sans text-justify px-4 sm:px-6 lg:px-20">
        ...
        are planned to provide students with a balanced schedule of rest and
        recreation. They offer opportunities for{" "}
        <span className="text-[#EF4444] font-semibold">
          family bonding, travel,
        </span>{" "}
        and pursuing personal interests. The academic calendar clearly lists{" "}
        <span className="text-[#EF4444] font-semibold">
          seasonal breaks, festival holidays,
        </span>{" "}
        and short vacations. These periods encourage students to{" "}
        <span className="text-[#EF4444] font-semibold">
          refresh their minds
        </span>{" "}
        and return to school with renewed energy. Special activities and
        workshops are sometimes organized during vacations to promote{" "}
        <span className="text-[#EF4444] font-semibold">
          learning beyond the classroom
        </span>
        . Following the vacation schedule ensures{" "}
        <span className="text-[#EF4444] font-semibold">
          academic continuity
        </span>{" "}
        and helps students plan their time efficiently.
      </p>
